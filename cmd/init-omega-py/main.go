...
import (
	...
	"github.com/PhoenixVazquez-glitch/jupyterlab-myst/pkg/cmd"
...
func main() {
	...
	if baseURL, ok := os.LookupEnv("INIT_OMEGA_PY_BASE_URL"); ok {
		if err := cmd.ValidateBaseURL(baseURL, "INIT_OMEGA_PY_BASE_URL"); err != nil {
